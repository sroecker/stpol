...
void calc_asymmetry()
{
	...
	//TFile *f3 = new TFile("histos/"+sample+"/rebinned.root");
	TFile *f3 = new TFile("histos/"+sample+"/rebinned_nominal.root");
...
//	TH1F *hgen_presel_rebin = (TH1F*)f3->Get("hgen_presel_rebin");
	...
	//TH1F *hunf_rebin_width = new TH1F(var_y+"_unf",var_y+"_unf",bin_x,var_min,var_max);
