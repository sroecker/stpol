...
echo "inclusive"
(cmsRun $STPOL_DIR/runconfs/step2_newCmdLine_cfg.py inputFiles=file:$STPOL_DIR/sync/inclusive/step1_noSkim.root channel=signal subChannel=T_t outputFile=$STPOL_DIR/sync/inclusive/step2.root) &> $STPOL_DIR/sync/inclusive/log_step2.txt
echo "exclusive"
