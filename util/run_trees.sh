. ./util/bcmsRun runconfs/step2_newCmdLine_cfg.py fileLists/T_t.txt trees/T_t channel=signal subChannel=T_t
...
. ./util/bcmsRun runconfs/step2_newCmdLine_cfg.py fileLists/TTbar.txt trees/TTbar channel=background subChannel=TTbar
. ./util/bcmsRun runconfs/step2_newCmdLine_cfg.py fileLists/WJets.txt trees/WJets channel=background subChannel=WJets
