...
JSON=http://cms-service-dqm.web.cern.ch/cms-service-dqm/CAF/certification/Collisions12/8TeV/Reprocessing/Cert_190456-208686_8TeV_22Jan2013ReReco_Collisions12_JSON.txt
echo "RunA"
filter $JSON 190456 193621
echo "RunB"
filter $JSON 193834 196531
echo "RunC"
filter $JSON 198022 203742
echo "RunD"
filter $JSON 203777 208686
