...
def SingleTopStep2():
    ...
    process.trueLeptonNTupleProducer.variables.append(cms.untracked.PSet(
                tag=cms.untracked.string("trueLeptonPdgId"),
                quantity=cms.untracked.string("trueLeptonPdgId")
            ))
