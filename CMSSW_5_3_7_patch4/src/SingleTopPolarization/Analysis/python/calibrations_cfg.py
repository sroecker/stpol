...
eff_ex_WJets_inclusive_2J =  {
    'c': (0.033669202553330141, 8.7078623740220199e-07),
    'b': (0.15474389704684555, 3.0626084247596172e-06),
    'l': (0.00077350221843158252, 3.796120390908692e-07)
}

eff_ex_WJets_inclusive_3J =  {
    'c': (0.047166694074271022, 1.6712552340373514e-06),
    'b': (0.23400361829108529, 3.8975395369241771e-06),
    'l': (0.00073873536881525765, 8.2955693648926585e-07)
}

eff_ex_T_t_2J =  {
    'c': (0.0025906670144525286, 1.5520465333569895e-06),
    'b': (0.44922469476074101, 2.3290812525022726e-07),
    'l': (0.0001, -1)
}

eff_ex_T_t_3J =  {
    'c': (0.0075754770773320693, 2.647378053639123e-06),
    'b': (0.58066222522631761, 4.4443449005479932e-07),
    'l': (0.00063202787347951112, 7.6734921984703091e-07)
}

eff_ex_TTbar_inclusive_2J =  {
    'c': (0.027368308408464645, 1.381620396746298e-06),
    'b': (0.37158178724055058, 4.4833184660839811e-07),
    'l': (0.0010192517018663863, 6.8891637980829315e-07)
}

eff_ex_TTbar_inclusive_3J =  {
    'c': (0.026405055702652745, 8.7925344497782043e-07),
    'b': (0.48746501312608759, 3.2499313136967755e-07),
    'l': (0.0010913820425246931, 5.0406148279971367e-07)
}
