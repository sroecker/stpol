...
for hist in session.query(Histogram).\
            ...
            filter((Histogram.cut=="n_tags==0.0 && true_b_count==0.0") | (Histogram.cut=="n_tags==0.0 && true_b_count==1.0") | (Histogram.cut=="n_tags==0.0 && true_b_count==2.0") | (Histogram.cut=="n_tags==0.0 && true_b_count==3.0")).\
...
c = ROOT.TCanvas("c")
c.SetLogy()
names = ["true_b_0", "true_b_1", "true_b_2", "true_b_3"]
titles = ["0 true b-jets", "1 true b-jets", "2 true b-jets", "3 true b-jets"]
i = 0
for h in hists:
