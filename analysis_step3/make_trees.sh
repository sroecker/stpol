...
$STPOL_DIR/analysis_step3/suball.sh "--doControlVars --mtw --isMC" $OFDIR/mu/iso/nominal $FLDIR/iso/nominal/mc/*
$STPOL_DIR/analysis_step3/suball.sh "--doControlVars --mtw --isMC" $OFDIR/mu/antiiso/nominal $FLDIR/antiiso/nominal/mc/*
