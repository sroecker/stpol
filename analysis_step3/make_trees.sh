...
$STPOL_DIR/analysis_step3/suball.sh "--lepton=mu" $OFDIR/mu/iso/nominal $FLDIR/iso/nominal/data/SingleMu*
$STPOL_DIR/analysis_step3/suball.sh "--lepton=mu" $OFDIR/mu/antiiso/nominal $FLDIR/antiiso/nominal/data/SingleMu*
...
$STPOL_DIR/analysis_step3/suball.sh "--lepton=ele" $OFDIR/ele/iso/nominal $FLDIR/iso/nominal/data/SingleEle*
$STPOL_DIR/analysis_step3/suball.sh "--lepton=ele" $OFDIR/ele/antiiso/nominal $FLDIR/antiiso/nominal/data/SingleEle*
