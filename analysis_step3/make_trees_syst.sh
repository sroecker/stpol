...
OFDIR=out_step3_06_06 #$timestamp
...
$STPOL_DIR/analysis_step3/suball_syst.sh "--lepton=mu --doFinal" $OFDIR/mu/iso/Nominal $FILELIST/iso/nominal/data/SingleMu*
$STPOL_DIR/analysis_step3/suball_syst.sh "--lepton=mu --isAntiIso --doFinal" $OFDIR/mu/antiiso/Nominal $FILELIST/antiiso/nominal/data/SingleMu*
$STPOL_DIR/analysis_step3/suball_syst.sh "--lepton=mu --isMC --doFinal" $OFDIR/mu/iso/SYST $FILELIST_SYST/Iso/SYST/*

$STPOL_DIR/analysis_step3/suball_syst.sh "--lepton=ele --doFinal" $OFDIR/ele/iso/Nominal $FILELIST/iso/nominal/data/SingleEle*
$STPOL_DIR/analysis_step3/suball_syst.sh "--lepton=ele --isAntiIso --doFinal" $OFDIR/ele/antiiso/Nominal $FILELIST/antiiso/nominal/data/SingleEle*
$STPOL_DIR/analysis_step3/suball_syst.sh "--lepton=ele --isMC --doFinal" $OFDIR/ele/iso/SYST $FILELIST_SYST/Iso/SYST/*