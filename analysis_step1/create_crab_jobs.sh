...
#python $STPOL_DIR/util/datasets.py -t stpol_step1_$timestamp -T $STPOL_DIR/crabs/crab_MC_step1_glideInRemote.cfg -d S1_FSIM_WJ -o $STPOL_DIR/crabs/step1_FSIM_$timestamp
