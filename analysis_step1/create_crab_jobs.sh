...
#python $CMSSW_BASE/../util/datasets.py -t stpol_step1_$timestamp -T $CMSSW_BASE/../crabs/crab_MC_step1_glideInRemote.cfg -d S1_FSIM_WJ -o crabs/step1_FSIM_$timestamp
